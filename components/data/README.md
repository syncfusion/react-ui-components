...
To install `@syncfusion/react-data` and its dependent packages, use the following command:
...
## Changelog
Check the changelog [here](https://github.com/syncfusion/react-ui-components/blob/master/components/data/CHANGELOG.md). Get minor improvements and bug fixes every week to stay up to date with frequent updates.
