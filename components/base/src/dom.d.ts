 ...
 * @private
 */
export declare function prepend(fromElements: HTMLElement[] | NodeListOf<HTMLElement>, toElement: Element, isEval?: boolean): Element[] | NodeList;
/**
 ...
 * @private
 */
export declare function detach(element: Element | Node | HTMLElement): Element | null;
/**
 ...
 * @private
 */
export declare function attributes(element: Element | Node, attributes: {
    [key: string]: string;
}): Element;
/**
 ...
 * @private
 */
export declare function select(selector: string, context?: Document | Element): Element | null;
/**
 ...
 * @private
 */
export declare function selectAll(selector: string, context?: Document | Element): HTMLElement[] | [];
/**
 ...
 * @private
 */
export declare function closest(element: Element | Node, selector: string): Element | null;
/**
 ...
 * @private
 */
export declare function containsClass(ele: HTMLElement, className: string): boolean;
/**
 * Method to check whether the element matches the given selector.
 *
